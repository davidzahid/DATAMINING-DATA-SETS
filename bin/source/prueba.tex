...
dadioasundasuind\textbf{asiunsafnsai}unf{\Huge sauinfsauifuinsaf}
\begin{figure}
...
liz es de la universdidad y pertenece un 50\% a ella.
sf
\end{center}

\caption{este es un texto que no se que....}
\end{figure}
saffsasfafsasfafassfasfa
\subsection{nada}
\chapter{Capitulo 2}
